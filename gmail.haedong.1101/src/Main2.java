...
public class Main2 {
	...
	public static void main(String[] args) {
		...
		chicken_brand.side_menu = new String[]{"감튀","치즈볼","윙"};
		
//		for(int i = 0; i < 3; i++) {
//			chicken_brand.side_menu[i] = new String();
//		}
		
		chicken_brand.side_menu[0] = "양념감튀";
		...
		System.out.println(chicken_brand.brande_name + "=" + chicken_brand.best_menu + " : " + chicken_brand.price + "원 / " + chicken_brand.type + " / " +chicken_brand.side_menu[0] );
